...
class UpdateEntryModel:
    def __init__(self, entry_id: UUID, title: str, entry_text_rich: str, entry_text_raw: str, modified_at: datetime, modified_by: str, entry_text_summary: Optional[str]) -> None:
